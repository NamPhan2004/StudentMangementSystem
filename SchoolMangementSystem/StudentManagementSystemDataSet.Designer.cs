...
namespace SchoolMangementSystem {
    ...
    public partial class StudentManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class classDataTable : global::System.Data.TypedTableBase<classRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public classRow AddclassRow(string class_name, string teacher) {
            ...
            public string teacher {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'teacher\' in table \'class\' is DBNull.", e);
                    }
                }
                set {
...
namespace SchoolMangementSystem.StudentManagementSystemDataSetTableAdapters {
    ...
    public partial class classTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[class] ([class_name], [teacher]) VALUES (@class_name, @teacher" +
                ");\r\nSELECT class_id, class_name, teacher FROM class WHERE (class_id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[class] SET [class_name] = @class_name, [teacher] = @teacher WHERE (([class_id] = @Original_class_id) AND ((@IsNull_class_name = 1 AND [class_name] IS NULL) OR ([class_name] = @Original_class_name)) AND ((@IsNull_teacher = 1 AND [teacher] IS NULL) OR ([teacher] = @Original_teacher)));
SELECT class_id, class_name, teacher FROM class WHERE (class_id = @class_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SchoolMangementSystem.Properties.Settings.Default.StudentManagementSystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT class_id, class_name, teacher FROM dbo.class";
        ...
        public virtual int Fill(StudentManagementSystemDataSet.classDataTable dataTable) {
        ...
        public virtual StudentManagementSystemDataSet.classDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentManagementSystemDataSet.classDataTable dataTable = new StudentManagementSystemDataSet.classDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentManagementSystemDataSet.classDataTable dataTable) {
        ...
        public virtual int Delete(int Original_class_id, string Original_class_name, string Original_teacher) {
        ...
        public virtual int Insert(string class_name, string teacher) {
            if ((class_name == null)) {
        ...
        public virtual int Update(string class_name, string teacher, int Original_class_id, string Original_class_name, string Original_teacher, int class_id) {
            if ((class_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string class_name, string teacher, int Original_class_id, string Original_class_name, string Original_teacher) {
            return this.Update(class_name, teacher, Original_class_id, Original_class_name, Original_teacher, Original_class_id);
        }
    }
